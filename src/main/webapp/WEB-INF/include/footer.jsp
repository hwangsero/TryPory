        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="footer-widget">
                    <!-- Logo -->
                    <a href="index.html" class="foo-logo"><img src="${pageContext.request.contextPath}/assets/img/core-img//logo2.png" alt=""></a>
                ...
                <div class="footer-widget">
                    ...
                    <div class="single-blog-post style-2 d-flex">
                        <div class="post-thumbnail">
                            <img src="${pageContext.request.contextPath}/assets/img/bg-img/12.jpg" alt="">
                        </div>
                    ...
                    <div class="single-blog-post style-2 d-flex">
                        <div class="post-thumbnail">
                            <img src="${pageContext.request.contextPath}/assets/img/bg-img/13.jpg" alt="">
                        </div>
                        <div class="post-content">
